...
function PasswordModal({
  ...
  return (
    <Transition show={open} as={Fragment}>
      <Dialog onClose={handleClose} className="relative z-[100]">
        {/* 배경 */}
        <TransitionChild
          as={Fragment}
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-3">
                <input
                  ...
                  placeholder="비밀번호 입력"
                  autoFocus
                  className="w-full rounded-xl px-4 py-2.5 text-sm outline-none transition-all focus:ring-2 focus:ring-blue-500"
                  style={{
